...
| [`windows-cell.yml`](windows-cell.yml) | Deploys a windows1803 cell. | Requires that a windows1803 stemcell and fs release are uploaded to the Bosh director. **CAUTION:** Incompatible with `operations/windows2016-cell.yml`. |
