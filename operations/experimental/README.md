...
| [`enable-service-discovery.yml`](enable-service-discovery.yml) | Enables application service discovery | Requires bosh-dns-release >= 0.2.0, capi-release > 1.47.0, [enabling service bosh-dns in containers](use-bosh-dns-for-containers.yml) |
