...
| [`use-logcache-for-cloud-controller-app-stats.yml`](use-logcache-for-cloud-controller-app-stats.yml) | **DEPRECATED because the Cloud Controller now uses logcache for app stats by default** Configure Cloud Controller to use Log Cache instead of Traffic Controller for app container metrics. | |
