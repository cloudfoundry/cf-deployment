...
| [`enable-bpm-garden.yml`](enable-bpm-garden.yml) | Enables the [BOSH Process Manager](https://github.com/cloudfoundry/bpm-release) for Garden. | This ops file **cannot** be deployed in conjunction with `enable-oci-phase-1.yml`. | **NO** |
...
| [`use-mysql-version-8.4.yml`](use-mysql-version-8.4.yml)                                                                     | ***DEPRECATED: MySQL 8.4 is now the default in cf-deployment.yml. This ops file is a no-op and will be removed in the next major release.***                                                               | No longer required.                                                                                                                                         | **NO**                                                                |
...
| [`use-spot-instances.yml`](use-spot-instances.yml) | Adds the 'spot' vm_extension to all instance groups in cf-deployment to enable spot/preemptible instances. | Requires the 'spot' vm_extension to be defined in your cloud-config. See the ops file for IaaS-specific examples. | **NO** |
