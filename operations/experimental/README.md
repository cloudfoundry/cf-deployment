...
| [`use-compiled-releases-xenial-stemcell-windows-cell.yml`](use-compiled-releases-xenial-stemcell-windows-cell.yml) | Reverts to source version of releases required for Windows 2012R2 cells | Requires `use-compiled-releases-xenial-stemcell.yml` |
| [`use-compiled-releases-xenial-stemcell-windows1803-cell.yml`](use-compiled-releases-xenial-stemcell-windows1803-cell.yml) | Reverts to source version of releases required for Windows 1083 cells | Requires `use-compiled-releases-xenial-stemcell.yml` |
| [`use-compiled-releases-xenial-stemcell-windows2016-cell.yml`](use-compiled-releases-xenial-stemcell-windows2016-cell.yml) | Reverts to source version of releases required for Windows 2016 cells | Requires `use-compiled-releases-xenial-stemcell.yml` |
