...
| [`enable-container-proxy.yml`](enable-container-proxy.yml) | Enables container proxy on the Diego Cell `rep`. | Requires `enable-instance-identity-credentials.yml`. Deprecated in favor of `enable-routing-integrity.yml`. |
