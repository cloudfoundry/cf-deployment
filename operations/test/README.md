...
| [`remove-logging-pipeline-with-danger.yml`](remove-logging-pipeline-with-danger.yml) | Remove logging pipline v2 jobs. ||
| [`remove-logging-pipeline-with-danger-windows1803.yml`](remove-logging-pipeline-with-danger-windows1803.yml) | Remove logging pipline v2 jobs from the Windows 1803 Diego Cell. | Requires `../remove-logging-pipeline-with-danger.yml` |
| [`remove-logging-pipeline-with-danger-windows2019.yml`](remove-logging-pipeline-with-danger-windows2019.yml) | Remove logging pipline v2 jobs from the Windows 2019 Diego Cell. | Requires `../remove-logging-pipeline-with-danger.yml` |
