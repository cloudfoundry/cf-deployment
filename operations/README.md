...
| **GCP** | | |
| [`use-gcp-blobstore.yml`](use-gcp-blobstore.yml) | Replaces local WebDAV blobstore with external Google blobstore. | Introduces [new variables](example-vars-files/vars-use-gcp-blobstore.yml) for gcp credentials and bucket names. |
| **Openstack** | | |
