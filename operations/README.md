...
| [`enable-docker.yml`](enable-docker.yml) | Enables docker on the garden job under grootfs. | Introduces variables `graph-threshold`, `space-allocation` and `docker-registry` |
