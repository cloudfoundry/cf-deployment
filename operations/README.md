...
| [`use-trusted-ca-cert-for-apps.yml`](use-trusted-ca-cert-for-apps.yml) | Allows deployer inject a CA into the Diego trusted store by passing a variable `trusted_cert_for_apps` |  |
